...
const HeroSection: React.FC<HeroSectionProps> = ({ onOpenQuestionnaire }) => {
      ...
      <div className="container mx-auto px-4 z-10 py-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h1 className={`font-display font-black text-6xl md:text-7xl lg:text-8xl tracking-tight ${isTypingComplete ? 'animate-bounce-in' : ''}`}>
            ...
            <span 
              className="relative inline-block h-24 overflow-hidden"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '500ms' }}>
            <button 
              className="btn-aiwala text-lg px-8 py-4"
          ...
          <div className="pt-8 flex flex-wrap justify-center gap-8 text-gray-500 animate-fade-in-up" style={{ animationDelay: '800ms' }}>
